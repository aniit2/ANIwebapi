...
public class elderlyhomehk_kwonon : aniWebService {
    string dbHost = "database-server-01.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "elderlyhomehk_kwonon";//資料庫使用者帳號
    string dbPass = "nfC334558";//資料庫使用者密碼
    string dbName = "elderlyhomehk_kwonon";//資料庫名稱
    string db_testName = "elderlyhomehk_kwonon_test";//資料庫名稱

    string LoginName = "100088";//資料庫名稱
    string LoginPass = "e2b528ec109af1ae3b530d49aeb149e9";//資料庫名稱

    public elderlyhomehk_kwonon()
    {
