...
public class anidev : aniWebService
{
    string dbHost = "192.168.1.17";
    string dbPort = "3366";
    string dbUser = "anidev";//資料庫使用者帳號
    string dbPass = "nfc11559";//資料庫使用者密碼
    string dbName = "anidev";//資料庫名稱
    string db_testName = "anidev_test";//資料庫名稱

    string LoginName = "100039";//資料庫名稱
