...
public class seeyan : aniWebService
{
    string dbHost = "database-server-01.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "seeyan";//資料庫使用者帳號
    string dbPass = "nfc11537";//資料庫使用者密碼
    string dbName = "seeyan";//資料庫名稱
    string db_testName = "seeyan_test";//資料庫名稱

    string LoginName = "100013";//資料庫名稱
