...
public class seeyan2 : aniWebService
{

    string dbHost = "database-server-01.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "seeyan2";//資料庫使用者帳號
    string dbPass = "nfc11545";//資料庫使用者密碼
    string dbName = "seeyan2";//資料庫名稱
    string db_testName = "seeyan2_test";//資料庫名稱

    string LoginName = "100021";//資料庫名稱
