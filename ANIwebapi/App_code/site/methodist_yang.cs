...
public class methodist_yang : aniWebService
{
    string dbHost = "database-server-01.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "methodist_yang";//資料庫使用者帳號
    string dbPass = "nfc11579";//資料庫使用者密碼
    string dbName = "methodist_yang";//資料庫名稱
    string db_testName = "methodist_yang_test";//資料庫名稱

    string LoginName = "100059";//資料庫名稱
    string LoginPass = "e2b528ec109af1ae3b530d49aeb149e9";//資料庫名稱

    public methodist_yang()
    {
