...
public class gracenursing_tt : aniWebService
{
    string dbHost = "database-server-02.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "gracenursing_tt";//資料庫使用者帳號
    string dbPass = "nfc11556";//資料庫使用者密碼
    string dbName = "gracenursing_tt";//資料庫名稱
    string db_testName = "gracenursing_tt_test";//資料庫名稱

    string LoginName = "100036";//資料庫名稱
    string LoginPass = "e2b528ec109af1ae3b530d49aeb149e9";//資料庫名稱

    public gracenursing_tt()
    {
