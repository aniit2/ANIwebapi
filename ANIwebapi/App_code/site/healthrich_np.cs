...
public class healthrich_np : aniWebService
{
    string dbHost = "database-server-01.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "healthrich_np";//資料庫使用者帳號
    string dbPass = "nfc11562";//資料庫使用者密碼
    string dbName = "healthrich_np";//資料庫名稱
    string db_testName = "healthrich_np_test";//資料庫名稱

    string LoginName = "100042";//資料庫名稱
    string LoginPass = "e2b528ec109af1ae3b530d49aeb149e9";//資料庫名稱

    public healthrich_np()
    {
