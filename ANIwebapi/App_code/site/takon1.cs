...
public class takon1 : aniWebService
{
    string dbHost = "database-server-01.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "takon1";//資料庫使用者帳號
    string dbPass = "nfc11234";//資料庫使用者密碼
    string dbName = "takon1";//資料庫名稱
    string db_testName = "takon1_test";//資料庫名稱

    string LoginName = "100002";//資料庫名稱
