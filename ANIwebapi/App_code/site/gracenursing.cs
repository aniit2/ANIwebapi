...
public class gracenursing : aniWebService
{
    string dbHost = "database-server-02.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "gracenursing";//資料庫使用者帳號
    string dbPass = "nfc11557";//資料庫使用者密碼
    string dbName = "gracenursing";//資料庫名稱
    string db_testName = "gracenursing_test";//資料庫名稱

    string LoginName = "100034";//資料庫名稱
