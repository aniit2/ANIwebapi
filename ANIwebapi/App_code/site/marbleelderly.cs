...
public class marbleelderly : aniWebService
{
    string dbHost = "database-server-02.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "marbleelderly";//資料庫使用者帳號
    string dbPass = "nfc11563";//資料庫使用者密碼
    string dbName = "marbleelderly";//資料庫名稱
    string db_testName = "marbleelderly_test";//資料庫名稱

    string LoginName = "100043";//資料庫名稱
    string LoginPass = "e2b528ec109af1ae3b530d49aeb149e9";//資料庫名稱

    public marbleelderly()
    {
