...
public class elderlyhomehk_laiyan : aniWebService {
    string dbHost = "database-server-01.cyplnzjfey2i.ap-east-1.rds.amazonaws.com";
    string dbPort = "3306";
    string dbUser = "elderlyhomehk_laiyan";//資料庫使用者帳號
    string dbPass = "nfC42376";//資料庫使用者密碼
    string dbName = "elderlyhomehk_laiyan";//資料庫名稱
    string db_testName = "elderlyhomehk_laiyan_test";//資料庫名稱

    string LoginName = "100089";//資料庫名稱
    string LoginPass = "e2b528ec109af1ae3b530d49aeb149e9";//資料庫名稱

    public elderlyhomehk_laiyan()
    {
