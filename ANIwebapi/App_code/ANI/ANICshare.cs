...
namespace ANI.code
{
    ...
    class ANICshare
    {
        ...
        public int Ecxe_transaction_Sql2(string sql, string sql2, bool checkSql1ExecutedResultCnt)
        {

            conn.OpenMySql();
            System.Diagnostics.Trace.WriteLine(sql);
            Debug.Print(sql);
            int ret = conn.ExecSql_transaction2(sql, sql2, checkSql1ExecutedResultCnt);
            conn.CloseMySql();
            return ret;
